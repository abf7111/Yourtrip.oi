<section class="page-section bg-dark" id="home">
	...
	<a href="./?page=jeddah" class="btn btn btn-primary btn-flat"><div class=""></div> Jeddah</a>
		<a href="./?page=riyadh" class="btn btn btn-primary btn-flat"><div class=""></div>Riyadh </a>
		<a href="./?page=mecca" class="btn btn btn-primary btn-flat"><div class=""></div> Mecca</a>
	...
	<div class="w-100">
		<?php
		$packages = $conn->query("SELECT * FROM `packages` where location=2 order by rand() ");
