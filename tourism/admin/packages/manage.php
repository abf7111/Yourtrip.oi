...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="package-form">
            ...
            <div class="form-group">
				<label for="location" class="control-label">Section</label>
                <select name="location" id="status" class="custom-select selevt">
                <option value="1" <?php echo isset($location) && $location == 1 ? 'selected' : '' ?>>riyadh</option>
                <option value="2" <?php echo isset($location) && $location == 2 ? 'selected' : '' ?>>mecca</option>
                <option value="3" <?php echo isset($location) && $location == 3 ? 'selected' : '' ?>>jeddah</option>
                </select>
